...
col-xs-12" >
	<div class="thc-history-page-image-1 col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<img class="img-responsive front-history-page-image1" src="<?php echo file_create_url( $view->result[3]->_field_data['nid']['entity']->field_history_image['und'][0]['uri']); ?>" >
	</div>
...
col-xs-12" >
	<div class="thc-history-page-image-2 col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<img class="img-responsive front-history-page-image1" src="<?php echo file_create_url( $view->result[3]->_field_data['nid']['entity']->field_history_image['und'][1]['uri']); ?>" >
	</div>
...
col-xs-12" >
	<div class="thc-history-page-image-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<img class="img-responsive front-history-page-image1" src="<?php echo file_create_url( $view->result[3]->_field_data['nid']['entity']->field_history_image['und'][2]['uri']); ?>" >
	</div>
...
<img class="img-responsive front-history-page-image1" src="<?php echo file_create_url( $view->result[3]->_field_data['nid']['entity']->field_history_image['und'][3]['uri']); ?>" >
	</div>
