...
<div class="main-container container pt-container-full pt-container-nopadding">
  
<?php include_once (drupal_get_path('theme',$GLOBALS['theme']).'/templates/include/banner.tpl.php'); ?>

  <div class="row pt-attraction-clear-menu">
    <div class="pt-container-full">
      <?php print render($page['swas_top_full']); ?>
      </div>
      <div class ="container">
    <?php include_once (drupal_get_path('theme',$GLOBALS['theme']).'/templates/include/sidebar_first.tpl.php'); ?>

    <section class ="pt-container-nopadding <?php print $content_column_class; ?>">
